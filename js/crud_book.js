const getData = () => {
    fetch('https://books-app-12345.herokuapp.com/api/books').then(
        res => {
            return res.json();
        }
    ).then(
...
const postData = (e) => {
    ...
    fetch('https://books-app-12345.herokuapp.com/api/books', options).then(
        res => {
            return res.json();
        }
    ).then(
...
const deleteData = (e) => {
        ...
        fetch(`https://books-app-12345.herokuapp.com/api/books/${bookId}`, options).then(
            res => {
                return res.json();
            }
        ).then(
...
const editData = (e) => {
    ...
    fetch(`https://books-app-12345.herokuapp.com/api/books${currentEditBook}`, options).then(
        res => {
            return res.json();
        }
    ).then(
